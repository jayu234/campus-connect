...
export default [
  ...
  Yup.object().shape({
    [college.name]: Yup.string().required(`${college.requiredErrorMsg}`).typeError(college.invalidErrorMsg),
    [course.name]: Yup.string().required(`${course.requiredErrorMsg}`).typeError(course.invalidErrorMsg),
    [city.name]: Yup.object().required(`${city.requiredErrorMsg}`).typeError(city.invalidErrorMsg),
  }),
  Yup.object().shape({
